...
export const clientsItem = [
   ...
   },
   {
      ...
      name: "Raff Labri",
      src: client06,
      review: "ICOM TELECOM has an impressive understanding of what’s needed to do an effective presentation. The stakeholders at work said it’s the best most complete PP template they’ve ever seen. ICOM TELECOM delivered more than I was expecting and we were really surprised with the quality of his work. Will work with ICOM TELECOM design again for sure!",
      links: [
         {
            id: 1,
   ...
   },
   {
      ...
      name: "David Buddy",
      src: client09,
      review: "We were surprised by the accuracy with which ICOM TELECOM Design nailed the overall design language that perfectly aligned with our personal preferences and the vision that we have for our young company.",
      links: [
         {
            id: 1,
            title: "branding",
...
export const aboutPartberItems = [
   ...
   },
   {
      ...
      src: officevibe,
      title: "Officevibe",
      para: "ICOM TELECOM has an impressive understanding of what's needed to do an effective presentation. The stakeholders at work said it's the best most complete PP template they've ever seen. ICOM TELECOM delivered more than I was expecting and we were really surprised with the quality of his work. Will work with ICOM TELECOM design again for sure!"
   },
   {
      id: 3,
      src: nestle,
...
export const FaqItems = [
   ...
   },
   {
      ...
      title: "Description",
      description: "Yes! We actively search for talent to join us in completing high-stake presentation design projects at ICOM TELECOM. As a presentation agency, we always aim to create the best products and services possible. Hence, we are looking for someone who will enjoy helping us fuse design and thinking into something impactful and beautiful.",
      links: [
         {
            id: 1,
            title: 1,
            description: "If you feel like you’re on top of your creative game, whether it’s storytelling, graphic design, or animation. Send us the CV and portfolio at Ihor@ICOM TELECOM.design with “CREATE AND THRILL” in the subject. We will get back to you and maybe schedule a call. If there’s a potential fit here, you will meet the team. If that goes well – you’ll become a part of it."
         },
         {
            id: 2,
            title: 2,
            description: "If you think you can improve our processes, marketing, PR, and communications, or you excel at managing people, we would love to hear from you. Send your message to hello@ICOM TELECOM.design with “-” and we will get back to you."
         },
      ],
      button: "read"
   },
   ...
   },
   {
      ...
      title: "Description",
      description: "Yes, why not. It’s a great chance to give back to the creative community by sharing and learning. Especially if the audience is relevant to the communication design subject. Or maybe it helps our clients in some way. We can’t know until we see some details, so drop us a line with a brief explanation at kseniia@ICOM TELECOM.design with the “Podcast/YT Proposal”.",
      links: [
         {
            id: 1,
            title: 1,
